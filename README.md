...
**Duration:** 18 September 2026 – 18 October 2026 (Remote)
...
* **Database Management:** SQL (Upcoming Tasks)
...
* **Key Achievements:**
  * Imputed missing patient ages using distribution-safe median group analysis.
  * Standardized clinical textual string discrepancies across record attributes.
  * Extracted structural descriptive metrics and exported a validated operational dataset (`cleaned_patient_records.csv`) for business intelligence onboarding.
